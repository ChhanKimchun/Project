        ...
        <div class="container-fluid">
          <div class="header-mobile-inner">
            <a class="logo" href="index.php">
              <div style="font-family:Khmer OS Siemreap; font-size: 20px;"> សាលាបឋមសិក្សាវេស្សវ័ណ</div>
            </a>
          ...
          <ul class="navbar-mobile__list list-unstyled">
            <li class="has-sub">
              ...
              <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                 <li>
                                    <a href="index.php">តារាងសិស្សចូលបណ្ណាល័យ</a>
                                </li>
                                <li>
                                    <a href="index2.php">តាបញ្ចីសៀវភៅសៀវភៅ</a>
                                </li>
                                <li>
                                    <a href="index3.php">ឈ្មោះសិស្សខ្ចីសៀវភៅ</a>
                                </li>
                                <li>
                                    <a href="index4.php">ឈ្មោះសិស្សសងសៀវភៅ</a>
                                </li>
              </ul>
            </li>
            <li>
